...
else
{
	...
	if($action == "")
	{
		...
		$main_content .= '[<a href="#General+Information" >General Information</a>] [<a href="#Registration" >Registration</a>] [<a href="#Public+Information" >Public Information</a>] [<a href="#Characters" >Characters</a>] ';
