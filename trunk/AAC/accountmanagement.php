<?PHP ##http://wklej.org/hash/0fc1f685524/
if(!$logged)
	if($action == "logout")
	...
	if($action == "") 
	{
						...
						<tr>
							<td>
								<table border="0" cellspacing="0" cellpadding="0" >
									<form action="index.php?subtopic=accountmanagement&action=logout" method="post" >
										<tr>
											<td style="border:0px;" >
		...
		<center>
			<table>
				<tr>
					...
					<td style="text-align:center;vertical-align:middle;horizontal-align:center;font-size:17px;font-weight:bold;" >Welcome to your account!<br/></td>
					<td><img src="'.$layout_name.'/images/content/headline-bracer-right.gif" /></td>
				</tr>
			</table><br/>
		</center>
		<td width="100%" align=center>[<a href="#General+Information">General Information</a>] [<a href="#Registration">Registration</a>] [<a href="#Public+Information">Public Information</a>] [<a href="#Characters">Characters</a>]</td>
		<td width=50%>
			<table border="0" cellspacing="0" cellpadding="0" >
		...
		<center>
			<table>
				<tr>
					<td><img src="'.$layout_name.'/images/content/headline-bracer-left.gif" /></td>
					<td style="text-align:center;vertical-align:middle;horizontal-align:center;font-size:17px;font-weight:bold;" >'.$welcome_msg.'<br/></td>
					<td><img src="'.$layout_name.'/images/content/headline-bracer-right.gif" /></td>
				</tr>
			</table><br/>
		</center>';
				...
				<div class="SmallBox" >
					<div class="MessageContainer" >
						...
						<div class="Message" >
							...
							<div align="center" >
								<table border="0" cellspacing="0" cellpadding="0" >
									<form action="index.php?subtopic=accountmanagement&action=changeemail" method="post" >
										<tr>
											<td style="border:0px;" >
												<div class="BigButton" style="background-image:url('.$layout_name.'/images/buttons/sbutton.gif)" >
													<div onMouseOver="MouseOverBigButton(this);" onMouseOut="MouseOutBigButton(this);" >
		...
		$main_content .= '<a name="General+Information" ></a>
										...
										<td>
											<table class="InnerTableButtonRow" cellpadding="0" cellspacing="0" >
												<tr>
													<td>
														<table border="0" cellspacing="0" cellpadding="0" >
															<form action="index.php?subtopic=accountmanagement&action=changepassword" method="post" >
																<tr>
																	<td style="border:0px;" >
																		<div class="BigButton" style="background-image:url('.$layout_name.'/images/buttons/sbutton.gif)" >
																			<div onMouseOver="MouseOverBigButton(this);" onMouseOut="MouseOutBigButton(this);" >
													...
													<td>
														<table border="0" cellspacing="0" cellpadding="0" >
															<form action="index.php?subtopic=accountmanagement&action=changeemail" method="post" >
																<tr>
																	<td style="border:0px;" ><input type="hidden" name=newemail value="">
																		<input type="hidden" name=newemaildate value=0 >
																			<div class="BigButton" style="background-image:url('.$layout_name.'/images/buttons/sbutton.gif)" >
																				...
																				<input class="ButtonText" type="image" name="Change Email" alt="Change Email" src="'.$layout_name.'/images/buttons/_sbutton_changeemail.gif" >
																			</div>
																		</div>
																	</td>
																</tr>
		...
		$main_content .= '<a name="Characters" ></a>
			<div class="TopButtonContainer" >
				<div class="TopButton" >
					<a href="#top" ><image style="border:0px;" src="'.$layout_name.'/images/content/back-to-top.gif" /></a>
				</div>
		...
		foreach($account_players as $account_player) 
		{
			...
			if($account_player->isNameLocked())
				if($account_player->getOldName())
					...
					$main_content .= '<font color="red"><b>[NAMELOCK: 
										<form action="" method="GET">
											<input name="subtopic" type="hidden" value="accountmanagement" />
											<input name="action" type="hidden" value="newnick" />
											<input name="name" type="hidden" value="'.$account_player->getName().'" />
											<input name="name_new" type="text" value="Enter here new nick" size="16" />
											<input type="submit" value="Set new nick" />
										</form>]</b></font>';
...
//## CREATE CHARACTER on account ###
	...
	{
		$points = $account_logged->getPremiumPoints();
		if($points >= $config['site']['char_price'])
		{
			...
			else
			{
				...
				{      
					...
					if(empty($newchar_errors))
					{
						...
						$account_logged->setPremiumPoints($account_logged->getPremiumPoints()-$config['site']['char_price']);
						$account_logged->save();
						$player->save();
						unset($player);
						$player = $ots->createObject('Player');
		...
		{
					$main_content .= '<div class="SmallBox" >  <div class="MessageContainer" >    <div class="BoxFrameHorizontal" style="background-image:url('.$layout_name.'/images/content/box-frame-horizontal.gif);" /></div>    <div class="BoxFrameEdgeLeftTop" style="background-image:url('.$layout_name.'/images/content/box-frame-edge.gif);" /></div>    <div class="BoxFrameEdgeRightTop" style="background-image:url('.$layout_name.'/images/content/box-frame-edge.gif);" /></div>    <div class="ErrorMessage" >      <div class="BoxFrameVerticalLeft" style="background-image:url('.$layout_name.'/images/content/box-frame-vertical.gif);" /></div>      <div class="BoxFrameVerticalRight" style="background-image:url('.$layout_name.'/images/content/box-frame-vertical.gif);" /></div>      <div class="AttentionSign" style="background-image:url('.$layout_name.'/images/content/attentionsign.gif);" /></div><b>The Following Errors Have Occurred:</b><br/>';
					$main_content .= 'You need '.$config['site']['char_price'].' premium points to creat char. You have <b>'.$points.'</b> premium points.';
					$main_content .= '</div>    <div class="BoxFrameHorizontal" style="background-image:url('.$layout_name.'/images/content/box-frame-horizontal.gif);" /></div>    <div class="BoxFrameEdgeRightBottom" style="background-image:url('.$layout_name.'/images/content/box-frame-edge.gif);" /></div>    <div class="BoxFrameEdgeLeftBottom" style="background-image:url('.$layout_name.'/images/content/box-frame-edge.gif);" /></div>  </div></div><br/>';
					$main_content .= '<center><table border="0" cellspacing="0" cellpadding="0" ><form action="?subtopic=accountmanagement" method="post" ><tr><td style="border:0px;" ><div class="BigButton" style="background-image:url('.$layout_name.'/images/buttons/sbutton.gif)" ><div onMouseOver="MouseOverBigButton(this);" onMouseOut="MouseOutBigButton(this);" ><div class="BigButtonOver" style="background-image:url('.$layout_name.'/images/buttons/sbutton_over.gif);" ></div><input class="ButtonText" type="image" name="Back" alt="Back" src="'.$layout_name.'/images/buttons/_sbutton_back.gif" ></div></div></td></tr></form></table></center>';
					$main_content .= '<div style="text-align: right; font-size: 10px;">Coded by <a target="blank" href="http://tibia.net.pl/members/xart-irok.html">Xart Irok</a></div>';
		}
	}
}
?>