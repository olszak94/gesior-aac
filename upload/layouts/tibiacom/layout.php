					...
					<div id='Menu'>
						...
						<div id='support' class='menuitem'>
							...
							<div id='support_Submenu' class='Submenu'>
								...
								<a href='?subtopic=tracker'>
									<div id='submenu_tracker' class='Submenuitem' onMouseOver='MouseOverSubmenuItem(this)' onMouseOut='MouseOutSubmenuItem(this)'>
										<div class='LeftChain' style='background-image:url(<?PHP echo $layout_name; ?>/images/general/chain.gif);'></div>
										<div id='ActiveSubmenuItemIcon_tracker' class='ActiveSubmenuItemIcon' style='background-image:url(<?PHP echo $layout_name; ?>/images/menu/icon-activesubmenu.gif);'></div>
										<div class='SubmenuitemLabel'>Tracker</div>
										<div class='RightChain' style='background-image:url(<?PHP echo $layout_name; ?>/images/general/chain.gif);'></div>
									</div>
								</a>
								...
								if($group_id_of_acc_logged >= 4)
									echo "<a href='?subtopic=namelock'>
										<div id='submenu_adminpanel' class='Submenuitem' onMouseOver='MouseOverSubmenuItem(this)' onMouseOut='MouseOutSubmenuItem(this)'>
											<div class='LeftChain' style='background-image:url(".$layout_name."/images/general/chain.gif);'></div>
											<div id='ActiveSubmenuItemIcon_adminpanel' class='ActiveSubmenuItemIcon' style='background-image:url(".$layout_name."/images/menu/icon-activesubmenu.gif);'></div>
											<div class='SubmenuitemLabel'><font color=\"red\">! Name Lock !</font></div>
											<div class='RightChain' style='background-image:url(".$layout_name."/images/general/chain.gif);'></div>
										</div>
									</a>";
								?>
				...
				<div id="ContentColumn">
					<div class="Content">
						<div id="ContentHelper">
							<script type="text/javascript" src="http://static.tibia.com/javascripts/newsticker.js"></script>
							...
							<div id="NewcomerBox" class="Themebox" style="background-image:url('.$layout_name.'/images/themeboxes/admin/admin.png);">
								<div id="lool" CLASS=white>
									<table><tr><td height="30">&nbsp;</td><td>&nbsp;</td></tr>
										...
										<tr><td height="10">&nbsp;</td><td><a href="?subtopic=adminpanel&action=editconfigs"><font color="white"><b>EDIT CONFIGS</b></font></a></td></tr>
										<tr><td height="10">&nbsp;</td><td><a href="?subtopic=adminpanel&action=editnews"><font color="white"><b>NEWS SYSTEM</b></font></a></td></tr>
									</table>
								</div>
