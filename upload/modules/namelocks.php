...
if($logged && $account_logged->getPageAccess() > 0)
{
	...
	$main_content .= '<table BORDER=0 CELLSPACING=1 CELLPADDING=4 width="100%" ><tr bgcolor="'.$config['site']['vdarkborder'].'"><td><font color="white"><b>- New nick proposition -</b></font></td><td><font color="white"><b>- ACCEPT -</b></font></td><td><font color="white"><b>- REJECT -</b></font></td></tr>';
	$number_of_rows = 1;
